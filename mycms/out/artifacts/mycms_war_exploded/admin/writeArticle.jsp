...
<div id="p" class="easyui-panel" title="编写内容" style="padding: 5px">
	...
	<table cellspacing="10px">
		...
		<tr>
			<td>内容属性：</td>
			<td>
				<input type="checkbox" id="isSlide" name="isSlide" onclick="checkChange()" value="1"/>幻灯内容
				<input type="checkbox" id="isRecommend" name="isRecommend" value="1"/>推荐内容
			</td>
		</tr>
...
<%--				到时候接收文件--%>
		...
		<tr>
			<td></td>
			<td>
				<a href="javascript:submitData()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">发布内容</a>
			</td>
		</tr>
	</table>
	</form>
